...
class ANetApiRequest {
  constructor(obj) {
    _logger.logger.debug('Enter ANetApiRequest constructor');
    ...
    _logger.logger.debug('Exit ANetApiRequest constructor');
  }
...
class ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter ANetApiResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'ErrorResponse': this
    };

    _logger.logger.debug('Exit ANetApiResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter ANetApiResponse constructor');
    ...
    _logger.logger.debug('Exit ANetApiResponse constructor');
  }
...
class ARBGetSubscriptionListSorting {
  constructor(obj) {
    _logger.logger.debug('Enter ARBGetSubscriptionListSorting constructor');
    ...
    _logger.logger.debug('Exit ARBGetSubscriptionListSorting constructor');
  }
...
class ARBSubscriptionMaskedType {
  constructor(obj) {
    _logger.logger.debug('Enter ARBSubscriptionMaskedType constructor');
    ...
    _logger.logger.debug('Exit ARBSubscriptionMaskedType constructor');
  }
  ...
  setArbTransactions(p_arbTransactions) {
...
class ARBSubscriptionType {
  constructor(obj) {
    _logger.logger.debug('Enter ARBSubscriptionType constructor');
    ...
    _logger.logger.debug('Exit ARBSubscriptionType constructor');
  }
...
class ARBTransactionList {
  constructor(obj) {
    _logger.logger.debug('Enter ARBTransactionList constructor');
    ...
    _logger.logger.debug('Exit ARBTransactionList constructor');
  }

  setArbTransaction(p_arbTransaction) {
...
class ArbTransaction {
  constructor(obj) {
    _logger.logger.debug('Enter ArbTransaction constructor');
    ...
    _logger.logger.debug('Exit ArbTransaction constructor');
  }
...
class ArrayOfAUResponseType {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfAUResponseType constructor');
    ...
    _logger.logger.debug('Exit ArrayOfAUResponseType constructor');
  }
...
class ArrayOfBatchDetailsType {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfBatchDetailsType constructor');
    ...
    _logger.logger.debug('Exit ArrayOfBatchDetailsType constructor');
  }
...
class ArrayOfBatchStatisticType {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfBatchStatisticType constructor');
    ...
    _logger.logger.debug('Exit ArrayOfBatchStatisticType constructor');
  }
...
class ArrayOfCardType {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfCardType constructor');
    ...
    _logger.logger.debug('Exit ArrayOfCardType constructor');
  }
...
class ArrayOfContactDetail {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfContactDetail constructor');

    if (arguments.length == 1) {
      if (obj != undefined && obj != null) {
        var contactDetailList = [];
        obj.forEach(function (item) {
          contactDetailList.push(new ContactDetailType(item));
        });
    ...
    _logger.logger.debug('Exit ArrayOfContactDetail constructor');
  }

  setContactDetail(p_contactDetail) {
    this.contactDetail = p_contactDetail;
  }

  getContactDetail() {
    if ('contactDetail' in this) {
...
class ArrayOfCurrencyCode {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfCurrencyCode constructor');
    ...
    _logger.logger.debug('Exit ArrayOfCurrencyCode constructor');
  }
...
class ArrayOfCustomerPaymentProfileListItemType {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfCustomerPaymentProfileListItemType constructor');
    ...
    _logger.logger.debug('Exit ArrayOfCustomerPaymentProfileListItemType constructor');
  }
...
class ArrayOfFDSFilter {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfFDSFilter constructor');
    ...
    _logger.logger.debug('Exit ArrayOfFDSFilter constructor');
  }
...
class ArrayOfFraudFilterType {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfFraudFilterType constructor');
    ...
    _logger.logger.debug('Exit ArrayOfFraudFilterType constructor');
  }

  setFraudFilter(p_fraudFilter) {
...
class ArrayOfLineItem {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfLineItem constructor');
    ...
    _logger.logger.debug('Exit ArrayOfLineItem constructor');
  }
...
class ArrayOfLong {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfLong constructor');
    ...
    _logger.logger.debug('Exit ArrayOfLong constructor');
  }
...
class ArrayOfMarketType {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfMarketType constructor');
    ...
    _logger.logger.debug('Exit ArrayOfMarketType constructor');
  }
...
class ArrayOfNumericString {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfNumericString constructor');
    ...
    _logger.logger.debug('Exit ArrayOfNumericString constructor');
  }
...
class ArrayOfPaymentMethod {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfPaymentMethod constructor');
    ...
    _logger.logger.debug('Exit ArrayOfPaymentMethod constructor');
  }
...
class ArrayOfPermissionType {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfPermissionType constructor');
    ...
    _logger.logger.debug('Exit ArrayOfPermissionType constructor');
  }
...
class ArrayOfProcessorType {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfProcessorType constructor');
    ...
    _logger.logger.debug('Exit ArrayOfProcessorType constructor');
  }

  setProcessor(p_processor) {
...
class ArrayOfProductCode {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfProductCode constructor');
    ...
    _logger.logger.debug('Exit ArrayOfProductCode constructor');
  }

  setProductCode(p_productCode) {
...
class ArrayOfReturnedItem {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfReturnedItem constructor');
    ...
    _logger.logger.debug('Exit ArrayOfReturnedItem constructor');
  }
...
class ArrayOfSetting {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfSetting constructor');
    ...
    _logger.logger.debug('Exit ArrayOfSetting constructor');
  }
...
class ArrayOfString {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfString constructor');
    ...
    _logger.logger.debug('Exit ArrayOfString constructor');
  }
...
class ArrayOfSubscription {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfSubscription constructor');
    ...
    _logger.logger.debug('Exit ArrayOfSubscription constructor');
  }
...
class ArrayOfTransactionSummaryType {
  constructor(obj) {
    _logger.logger.debug('Enter ArrayOfTransactionSummaryType constructor');
    ...
    _logger.logger.debug('Exit ArrayOfTransactionSummaryType constructor');
  }
...
class AuDetailsType {
  constructor(obj) {
    _logger.logger.debug('Enter AuDetailsType constructor');
    ...
    _logger.logger.debug('Exit AuDetailsType constructor');
  }
...
class AuResponseType {
  constructor(obj) {
    _logger.logger.debug('Enter AuResponseType constructor');
    ...
    _logger.logger.debug('Exit AuResponseType constructor');
  }
...
class BankAccountMaskedType {
  constructor(obj) {
    _logger.logger.debug('Enter BankAccountMaskedType constructor');
    ...
    _logger.logger.debug('Exit BankAccountMaskedType constructor');
  }
...
class BankAccountType {
  constructor(obj) {
    _logger.logger.debug('Enter BankAccountType constructor');
    ...
    _logger.logger.debug('Exit BankAccountType constructor');
  }
...
class BatchDetailsType {
  constructor(obj) {
    _logger.logger.debug('Enter BatchDetailsType constructor');
    ...
    _logger.logger.debug('Exit BatchDetailsType constructor');
  }
...
class BatchStatisticType {
  constructor(obj) {
    _logger.logger.debug('Enter BatchStatisticType constructor');
    ...
    _logger.logger.debug('Exit BatchStatisticType constructor');
  }
...
class CardArt {
  constructor(obj) {
    _logger.logger.debug('Enter CardArt constructor');
    ...
    _logger.logger.debug('Exit CardArt constructor');
  }
...
class CcAuthenticationType {
  constructor(obj) {
    _logger.logger.debug('Enter CcAuthenticationType constructor');
    ...
    _logger.logger.debug('Exit CcAuthenticationType constructor');
  }
...
class ContactDetailType {
  constructor(obj) {
    _logger.logger.debug('Enter ContactDetailType constructor');
    ...
    _logger.logger.debug('Exit ContactDetailType constructor');
  }
...
class CreateProfileResponse {
  constructor(obj) {
    _logger.logger.debug('Enter CreateProfileResponse constructor');
    ...
    _logger.logger.debug('Exit CreateProfileResponse constructor');
  }
...
class CreditCardMaskedType {
  constructor(obj) {
    _logger.logger.debug('Enter CreditCardMaskedType constructor');
    ...
    _logger.logger.debug('Exit CreditCardMaskedType constructor');
  }
  ...
  setIssuerNumber(p_issuerNumber) {
...
class CreditCardSimpleType {
  constructor(obj) {
    _logger.logger.debug('Enter CreditCardSimpleType constructor');
    ...
    _logger.logger.debug('Exit CreditCardSimpleType constructor');
  }
...
class CreditCardTrackType {
  constructor(obj) {
    _logger.logger.debug('Enter CreditCardTrackType constructor');
    ...
    _logger.logger.debug('Exit CreditCardTrackType constructor');
  }
...
class CustomerDataType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerDataType constructor');
    ...
    _logger.logger.debug('Exit CustomerDataType constructor');
  }
...
class CustomerPaymentProfileBaseType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerPaymentProfileBaseType constructor');
    ...
    _logger.logger.debug('Exit CustomerPaymentProfileBaseType constructor');
  }
...
class CustomerPaymentProfileListItemType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerPaymentProfileListItemType constructor');
    ...
    _logger.logger.debug('Exit CustomerPaymentProfileListItemType constructor');
  }

  setDefaultPaymentProfile(p_defaultPaymentProfile) {
...
class CustomerPaymentProfileSorting {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerPaymentProfileSorting constructor');
    ...
    _logger.logger.debug('Exit CustomerPaymentProfileSorting constructor');
  }
...
class CustomerProfileBaseType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerProfileBaseType constructor');
    ...
    _logger.logger.debug('Exit CustomerProfileBaseType constructor');
  }
...
class CustomerProfileIdType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerProfileIdType constructor');
    ...
    _logger.logger.debug('Exit CustomerProfileIdType constructor');
  }
...
class CustomerProfilePaymentType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerProfilePaymentType constructor');
    ...
    _logger.logger.debug('Exit CustomerProfilePaymentType constructor');
  }
...
class CustomerProfileSummaryType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerProfileSummaryType constructor');
    ...
    _logger.logger.debug('Exit CustomerProfileSummaryType constructor');
  }
...
class CustomerType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerType constructor');
    ...
    _logger.logger.debug('Exit CustomerType constructor');
  }
...
class DriversLicenseMaskedType {
  constructor(obj) {
    _logger.logger.debug('Enter DriversLicenseMaskedType constructor');
    ...
    _logger.logger.debug('Exit DriversLicenseMaskedType constructor');
  }
...
class DriversLicenseType {
  constructor(obj) {
    _logger.logger.debug('Enter DriversLicenseType constructor');
    ...
    _logger.logger.debug('Exit DriversLicenseType constructor');
  }
...
class EmvTag {
  constructor(obj) {
    _logger.logger.debug('Enter EmvTag constructor');
    ...
    _logger.logger.debug('Exit EmvTag constructor');
  }
...
class EncryptedTrackDataType {
  constructor(obj) {
    _logger.logger.debug('Enter EncryptedTrackDataType constructor');
    ...
    _logger.logger.debug('Exit EncryptedTrackDataType constructor');
  }
...
class EnumCollection {
  constructor(obj) {
    _logger.logger.debug('Enter EnumCollection constructor');
    ...
    _logger.logger.debug('Exit EnumCollection constructor');
  }
...
class ExtendedAmountType {
  constructor(obj) {
    _logger.logger.debug('Enter ExtendedAmountType constructor');
    ...
    _logger.logger.debug('Exit ExtendedAmountType constructor');
  }
...
class FDSFilterType {
  constructor(obj) {
    _logger.logger.debug('Enter FDSFilterType constructor');
    ...
    _logger.logger.debug('Exit FDSFilterType constructor');
  }
...
class FingerPrintType {
  constructor(obj) {
    _logger.logger.debug('Enter FingerPrintType constructor');
    ...
    _logger.logger.debug('Exit FingerPrintType constructor');
  }
...
class FraudInformationType {
  constructor(obj) {
    _logger.logger.debug('Enter FraudInformationType constructor');
    ...
    _logger.logger.debug('Exit FraudInformationType constructor');
  }

  setFraudFilterList(p_fraudFilterList) {
...
class HeldTransactionRequestType {
  constructor(obj) {
    _logger.logger.debug('Enter HeldTransactionRequestType constructor');
    ...
    _logger.logger.debug('Exit HeldTransactionRequestType constructor');
  }
...
class ImpersonationAuthenticationType {
  constructor(obj) {
    _logger.logger.debug('Enter ImpersonationAuthenticationType constructor');
    ...
    _logger.logger.debug('Exit ImpersonationAuthenticationType constructor');
  }
...
class IsAliveRequest {
  getJSON() {
    _logger.logger.debug('Enter IsAliveRequest getJSON');
    ...
    _logger.logger.debug('Exit IsAliveRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter IsAliveRequest constructor');
    ...
    _logger.logger.debug('Exit IsAliveRequest constructor');
  }
...
class KeyBlock {
  constructor(obj) {
    _logger.logger.debug('Enter KeyBlock constructor');
    ...
    _logger.logger.debug('Exit KeyBlock constructor');
  }
...
class KeyManagementScheme {
  constructor(obj) {
    _logger.logger.debug('Enter KeyManagementScheme constructor');
    ...
    _logger.logger.debug('Exit KeyManagementScheme constructor');
  }
...
class KeyValue {
  constructor(obj) {
    _logger.logger.debug('Enter KeyValue constructor');
    ...
    _logger.logger.debug('Exit KeyValue constructor');
  }
...
class LineItemType {
  constructor(obj) {
    _logger.logger.debug('Enter LineItemType constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('unitOfMeasure' in obj && obj.unitOfMeasure != null) {
        this.setUnitOfMeasure(obj.unitOfMeasure);
      }

      if ('typeOfSupply' in obj && obj.typeOfSupply != null) {
        this.setTypeOfSupply(obj.typeOfSupply);
      }

      if ('taxRate' in obj && obj.taxRate != null) {
        this.setTaxRate(obj.taxRate);
      }

      if ('taxAmount' in obj && obj.taxAmount != null) {
        this.setTaxAmount(obj.taxAmount);
      }

      if ('nationalTax' in obj && obj.nationalTax != null) {
        this.setNationalTax(obj.nationalTax);
      }

      if ('localTax' in obj && obj.localTax != null) {
        this.setLocalTax(obj.localTax);
      }

      if ('vatRate' in obj && obj.vatRate != null) {
        this.setVatRate(obj.vatRate);
      }

      if ('alternateTaxId' in obj && obj.alternateTaxId != null) {
        this.setAlternateTaxId(obj.alternateTaxId);
      }

      if ('alternateTaxType' in obj && obj.alternateTaxType != null) {
        this.setAlternateTaxType(obj.alternateTaxType);
      }

      if ('alternateTaxTypeApplied' in obj && obj.alternateTaxTypeApplied != null) {
        this.setAlternateTaxTypeApplied(obj.alternateTaxTypeApplied);
      }

      if ('alternateTaxRate' in obj && obj.alternateTaxRate != null) {
        this.setAlternateTaxRate(obj.alternateTaxRate);
      }

      if ('alternateTaxAmount' in obj && obj.alternateTaxAmount != null) {
        this.setAlternateTaxAmount(obj.alternateTaxAmount);
      }

      if ('totalAmount' in obj && obj.totalAmount != null) {
        this.setTotalAmount(obj.totalAmount);
      }

      if ('commodityCode' in obj && obj.commodityCode != null) {
        this.setCommodityCode(obj.commodityCode);
      }

      if ('productCode' in obj && obj.productCode != null) {
        this.setProductCode(obj.productCode);
      }

      if ('productSKU' in obj && obj.productSKU != null) {
        this.setProductSKU(obj.productSKU);
      }

      if ('discountRate' in obj && obj.discountRate != null) {
        this.setDiscountRate(obj.discountRate);
      }

      if ('discountAmount' in obj && obj.discountAmount != null) {
        this.setDiscountAmount(obj.discountAmount);
      }

      if ('taxIncludedInTotal' in obj && obj.taxIncludedInTotal != null) {
        this.setTaxIncludedInTotal(obj.taxIncludedInTotal);
      }

      if ('taxIsAfterDiscount' in obj && obj.taxIsAfterDiscount != null) {
        this.setTaxIsAfterDiscount(obj.taxIsAfterDiscount);
      }
    } else {
      this.setItemId(null);
      this.setName(null);
    ...
    _logger.logger.debug('Exit LineItemType constructor');
  }
  ...
  setUnitOfMeasure(p_unitOfMeasure) {
    this.unitOfMeasure = p_unitOfMeasure;
  }

  getUnitOfMeasure() {
    if ('unitOfMeasure' in this) {
      return this.unitOfMeasure;
    }
  }

  setTypeOfSupply(p_typeOfSupply) {
    this.typeOfSupply = p_typeOfSupply;
  }

  getTypeOfSupply() {
    if ('typeOfSupply' in this) {
      return this.typeOfSupply;
    }
  }

  setTaxRate(p_taxRate) {
    this.taxRate = p_taxRate;
  }
  ...
  setTaxAmount(p_taxAmount) {
    this.taxAmount = p_taxAmount;
  }

  getTaxAmount() {
    if ('taxAmount' in this) {
      return this.taxAmount;
    }
  }

  setNationalTax(p_nationalTax) {
    this.nationalTax = p_nationalTax;
  }

  getNationalTax() {
    if ('nationalTax' in this) {
      return this.nationalTax;
    }
  }

  setLocalTax(p_localTax) {
    this.localTax = p_localTax;
  }
  ...
  setVatRate(p_vatRate) {
    this.vatRate = p_vatRate;
  }
  ...
  setAlternateTaxId(p_alternateTaxId) {
    this.alternateTaxId = p_alternateTaxId;
  }

  getAlternateTaxId() {
    if ('alternateTaxId' in this) {
      return this.alternateTaxId;
    }
  }

  setAlternateTaxType(p_alternateTaxType) {
    this.alternateTaxType = p_alternateTaxType;
  }

  getAlternateTaxType() {
    if ('alternateTaxType' in this) {
      return this.alternateTaxType;
    }
  }

  setAlternateTaxTypeApplied(p_alternateTaxTypeApplied) {
    this.alternateTaxTypeApplied = p_alternateTaxTypeApplied;
  }

  getAlternateTaxTypeApplied() {
    if ('alternateTaxTypeApplied' in this) {
      return this.alternateTaxTypeApplied;
    }
  }

  setAlternateTaxRate(p_alternateTaxRate) {
    this.alternateTaxRate = p_alternateTaxRate;
  }

  getAlternateTaxRate() {
    if ('alternateTaxRate' in this) {
      return this.alternateTaxRate;
    }
  }

  setAlternateTaxAmount(p_alternateTaxAmount) {
    this.alternateTaxAmount = p_alternateTaxAmount;
  }

  getAlternateTaxAmount() {
    if ('alternateTaxAmount' in this) {
      return this.alternateTaxAmount;
    }
  }

  setTotalAmount(p_totalAmount) {
    this.totalAmount = p_totalAmount;
  }

  getTotalAmount() {
    if ('totalAmount' in this) {
      return this.totalAmount;
    }
  }

  setCommodityCode(p_commodityCode) {
    this.commodityCode = p_commodityCode;
  }

  getCommodityCode() {
    if ('commodityCode' in this) {
  ...
  setProductSKU(p_productSKU) {
    this.productSKU = p_productSKU;
  }

  getProductSKU() {
    if ('productSKU' in this) {
      return this.productSKU;
    }
  }

  setDiscountRate(p_discountRate) {
    this.discountRate = p_discountRate;
  }

  getDiscountRate() {
    if ('discountRate' in this) {
      return this.discountRate;
    }
  }

  setDiscountAmount(p_discountAmount) {
    this.discountAmount = p_discountAmount;
  }

  getDiscountAmount() {
    if ('discountAmount' in this) {
      return this.discountAmount;
    }
  }

  setTaxIncludedInTotal(p_taxIncludedInTotal) {
    this.taxIncludedInTotal = p_taxIncludedInTotal;
  }

  getTaxIncludedInTotal() {
    if ('taxIncludedInTotal' in this) {
      return this.taxIncludedInTotal;
    }
  }

  setTaxIsAfterDiscount(p_taxIsAfterDiscount) {
    this.taxIsAfterDiscount = p_taxIsAfterDiscount;
  }

  getTaxIsAfterDiscount() {
    if ('taxIsAfterDiscount' in this) {
...
class ListOfAUDetailsType {
  constructor(obj) {
    _logger.logger.debug('Enter ListOfAUDetailsType constructor');
    ...
    _logger.logger.debug('Exit ListOfAUDetailsType constructor');
  }
...
class MerchantAuthenticationType {
  constructor(obj) {
    _logger.logger.debug('Enter MerchantAuthenticationType constructor');
    ...
    _logger.logger.debug('Exit MerchantAuthenticationType constructor');
  }
...
class MerchantContactType {
  constructor(obj) {
    _logger.logger.debug('Enter MerchantContactType constructor');
    ...
    _logger.logger.debug('Exit MerchantContactType constructor');
  }
...
class MessagesType {
  constructor(obj) {
    _logger.logger.debug('Enter MessagesType constructor');
    ...
    _logger.logger.debug('Exit MessagesType constructor');
  }
...
class MobileDeviceType {
  constructor(obj) {
    _logger.logger.debug('Enter MobileDeviceType constructor');
    ...
    _logger.logger.debug('Exit MobileDeviceType constructor');
  }
...
class NameAndAddressType {
  constructor(obj) {
    _logger.logger.debug('Enter NameAndAddressType constructor');
    ...
    _logger.logger.debug('Exit NameAndAddressType constructor');
  }
...
class OpaqueDataType {
  constructor(obj) {
    _logger.logger.debug('Enter OpaqueDataType constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('expirationTimeStamp' in obj && obj.expirationTimeStamp != null) {
        this.setExpirationTimeStamp(obj.expirationTimeStamp);
      }
    } else {
    ...
    _logger.logger.debug('Exit OpaqueDataType constructor');
  }
  ...
  setExpirationTimeStamp(p_expirationTimeStamp) {
    this.expirationTimeStamp = p_expirationTimeStamp;
  }

  getExpirationTimeStamp() {
    if ('expirationTimeStamp' in this) {
...
class OrderType {
  constructor(obj) {
    _logger.logger.debug('Enter OrderType constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('totalTaxTypeCode' in obj && obj.totalTaxTypeCode != null) {
        this.setTotalTaxTypeCode(obj.totalTaxTypeCode);
      }

      if ('purchaserVATRegistrationNumber' in obj && obj.purchaserVATRegistrationNumber != null) {
        this.setPurchaserVATRegistrationNumber(obj.purchaserVATRegistrationNumber);
      }

      if ('merchantVATRegistrationNumber' in obj && obj.merchantVATRegistrationNumber != null) {
        this.setMerchantVATRegistrationNumber(obj.merchantVATRegistrationNumber);
      }

      if ('vatInvoiceReferenceNumber' in obj && obj.vatInvoiceReferenceNumber != null) {
        this.setVatInvoiceReferenceNumber(obj.vatInvoiceReferenceNumber);
      }

      if ('purchaserCode' in obj && obj.purchaserCode != null) {
        this.setPurchaserCode(obj.purchaserCode);
      }

      if ('summaryCommodityCode' in obj && obj.summaryCommodityCode != null) {
        this.setSummaryCommodityCode(obj.summaryCommodityCode);
      }

      if ('purchaseOrderDateUTC' in obj && obj.purchaseOrderDateUTC != null) {
        this.setPurchaseOrderDateUTC(obj.purchaseOrderDateUTC);
      }

      if ('supplierOrderReference' in obj && obj.supplierOrderReference != null) {
        this.setSupplierOrderReference(obj.supplierOrderReference);
      }

      if ('authorizedContactName' in obj && obj.authorizedContactName != null) {
        this.setAuthorizedContactName(obj.authorizedContactName);
      }

      if ('cardAcceptorRefNumber' in obj && obj.cardAcceptorRefNumber != null) {
        this.setCardAcceptorRefNumber(obj.cardAcceptorRefNumber);
      }

      if ('amexDataTAA1' in obj && obj.amexDataTAA1 != null) {
        this.setAmexDataTAA1(obj.amexDataTAA1);
      }

      if ('amexDataTAA2' in obj && obj.amexDataTAA2 != null) {
        this.setAmexDataTAA2(obj.amexDataTAA2);
      }

      if ('amexDataTAA3' in obj && obj.amexDataTAA3 != null) {
        this.setAmexDataTAA3(obj.amexDataTAA3);
      }

      if ('amexDataTAA4' in obj && obj.amexDataTAA4 != null) {
        this.setAmexDataTAA4(obj.amexDataTAA4);
      }
    } else {
    ...
    _logger.logger.debug('Exit OrderType constructor');
  }
  ...
  setTotalTaxTypeCode(p_totalTaxTypeCode) {
    this.totalTaxTypeCode = p_totalTaxTypeCode;
  }

  getTotalTaxTypeCode() {
    if ('totalTaxTypeCode' in this) {
      return this.totalTaxTypeCode;
    }
  }

  setPurchaserVATRegistrationNumber(p_purchaserVATRegistrationNumber) {
    this.purchaserVATRegistrationNumber = p_purchaserVATRegistrationNumber;
  }

  getPurchaserVATRegistrationNumber() {
    if ('purchaserVATRegistrationNumber' in this) {
      return this.purchaserVATRegistrationNumber;
    }
  }

  setMerchantVATRegistrationNumber(p_merchantVATRegistrationNumber) {
    this.merchantVATRegistrationNumber = p_merchantVATRegistrationNumber;
  }

  getMerchantVATRegistrationNumber() {
    if ('merchantVATRegistrationNumber' in this) {
      return this.merchantVATRegistrationNumber;
    }
  }

  setVatInvoiceReferenceNumber(p_vatInvoiceReferenceNumber) {
    this.vatInvoiceReferenceNumber = p_vatInvoiceReferenceNumber;
  }

  getVatInvoiceReferenceNumber() {
    if ('vatInvoiceReferenceNumber' in this) {
      return this.vatInvoiceReferenceNumber;
    }
  }

  setPurchaserCode(p_purchaserCode) {
    this.purchaserCode = p_purchaserCode;
  }

  getPurchaserCode() {
    if ('purchaserCode' in this) {
      return this.purchaserCode;
    }
  }

  setSummaryCommodityCode(p_summaryCommodityCode) {
    this.summaryCommodityCode = p_summaryCommodityCode;
  }

  getSummaryCommodityCode() {
    if ('summaryCommodityCode' in this) {
      return this.summaryCommodityCode;
    }
  }

  setPurchaseOrderDateUTC(p_purchaseOrderDateUTC) {
    this.purchaseOrderDateUTC = p_purchaseOrderDateUTC;
  }

  getPurchaseOrderDateUTC() {
    if ('purchaseOrderDateUTC' in this) {
      return this.purchaseOrderDateUTC;
    }
  }

  setSupplierOrderReference(p_supplierOrderReference) {
    this.supplierOrderReference = p_supplierOrderReference;
  }

  getSupplierOrderReference() {
    if ('supplierOrderReference' in this) {
      return this.supplierOrderReference;
    }
  }

  setAuthorizedContactName(p_authorizedContactName) {
    this.authorizedContactName = p_authorizedContactName;
  }

  getAuthorizedContactName() {
    if ('authorizedContactName' in this) {
      return this.authorizedContactName;
    }
  }

  setCardAcceptorRefNumber(p_cardAcceptorRefNumber) {
    this.cardAcceptorRefNumber = p_cardAcceptorRefNumber;
  }

  getCardAcceptorRefNumber() {
    if ('cardAcceptorRefNumber' in this) {
      return this.cardAcceptorRefNumber;
    }
  }

  setAmexDataTAA1(p_amexDataTAA1) {
    this.amexDataTAA1 = p_amexDataTAA1;
  }

  getAmexDataTAA1() {
    if ('amexDataTAA1' in this) {
      return this.amexDataTAA1;
    }
  }

  setAmexDataTAA2(p_amexDataTAA2) {
    this.amexDataTAA2 = p_amexDataTAA2;
  }

  getAmexDataTAA2() {
    if ('amexDataTAA2' in this) {
      return this.amexDataTAA2;
    }
  }

  setAmexDataTAA3(p_amexDataTAA3) {
    this.amexDataTAA3 = p_amexDataTAA3;
  }

  getAmexDataTAA3() {
    if ('amexDataTAA3' in this) {
      return this.amexDataTAA3;
    }
  }

  setAmexDataTAA4(p_amexDataTAA4) {
    this.amexDataTAA4 = p_amexDataTAA4;
  }

  getAmexDataTAA4() {
    if ('amexDataTAA4' in this) {
...
class OtherTaxType {
  constructor(obj) {
    _logger.logger.debug('Enter OtherTaxType constructor');

    if (arguments.length == 1) {
      if ('nationalTaxAmount' in obj && obj.nationalTaxAmount != null) {
        this.setNationalTaxAmount(obj.nationalTaxAmount);
      }

      if ('localTaxAmount' in obj && obj.localTaxAmount != null) {
        this.setLocalTaxAmount(obj.localTaxAmount);
      }
      ...
      if ('vatTaxRate' in obj && obj.vatTaxRate != null) {
        this.setVatTaxRate(obj.vatTaxRate);
      }

      if ('vatTaxAmount' in obj && obj.vatTaxAmount != null) {
        this.setVatTaxAmount(obj.vatTaxAmount);
      }
    } else {
    ...
    _logger.logger.debug('Exit OtherTaxType constructor');
  }

  setNationalTaxAmount(p_nationalTaxAmount) {
    this.nationalTaxAmount = p_nationalTaxAmount;
  }

  getNationalTaxAmount() {
    if ('nationalTaxAmount' in this) {
      return this.nationalTaxAmount;
    }
  }

  setLocalTaxAmount(p_localTaxAmount) {
    this.localTaxAmount = p_localTaxAmount;
  }

  getLocalTaxAmount() {
    if ('localTaxAmount' in this) {
  ...
  setVatTaxRate(p_vatTaxRate) {
    this.vatTaxRate = p_vatTaxRate;
  }

  getVatTaxRate() {
    if ('vatTaxRate' in this) {
      return this.vatTaxRate;
    }
  }

  setVatTaxAmount(p_vatTaxAmount) {
    this.vatTaxAmount = p_vatTaxAmount;
  }

  getVatTaxAmount() {
    if ('vatTaxAmount' in this) {
...
class Paging {
  constructor(obj) {
    _logger.logger.debug('Enter Paging constructor');
    ...
    _logger.logger.debug('Exit Paging constructor');
  }
...
class PayPalType {
  constructor(obj) {
    _logger.logger.debug('Enter PayPalType constructor');
    ...
    _logger.logger.debug('Exit PayPalType constructor');
  }
...
class PaymentDetails {
  constructor(obj) {
    _logger.logger.debug('Enter PaymentDetails constructor');
    ...
    _logger.logger.debug('Exit PaymentDetails constructor');
  }
...
class PaymentEmvType {
  constructor(obj) {
    _logger.logger.debug('Enter PaymentEmvType constructor');
    ...
    _logger.logger.debug('Exit PaymentEmvType constructor');
  }
...
class PaymentMaskedType {
  constructor(obj) {
    _logger.logger.debug('Enter PaymentMaskedType constructor');
    ...
    _logger.logger.debug('Exit PaymentMaskedType constructor');
  }
...
class PaymentProfile {
  constructor(obj) {
    _logger.logger.debug('Enter PaymentProfile constructor');
    ...
    _logger.logger.debug('Exit PaymentProfile constructor');
  }
...
class PaymentScheduleType {
  constructor(obj) {
    _logger.logger.debug('Enter PaymentScheduleType constructor');
    ...
    _logger.logger.debug('Exit PaymentScheduleType constructor');
  }
...
class PaymentSimpleType {
  constructor(obj) {
    _logger.logger.debug('Enter PaymentSimpleType constructor');
    ...
    _logger.logger.debug('Exit PaymentSimpleType constructor');
  }
...
class PaymentType {
  constructor(obj) {
    _logger.logger.debug('Enter PaymentType constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('dataSource' in obj && obj.dataSource != null) {
        this.setDataSource(obj.dataSource);
      }
    } else {
      this.setCreditCard(null);
      this.setBankAccount(null);
    ...
    _logger.logger.debug('Exit PaymentType constructor');
  }
...
class PermissionType {
  constructor(obj) {
    _logger.logger.debug('Enter PermissionType constructor');
    ...
    _logger.logger.debug('Exit PermissionType constructor');
  }
...
class ProcessingOptions {
  constructor(obj) {
    _logger.logger.debug('Enter ProcessingOptions constructor');

    if (arguments.length == 1) {
      if ('isFirstRecurringPayment' in obj && obj.isFirstRecurringPayment != null) {
        this.setIsFirstRecurringPayment(obj.isFirstRecurringPayment);
      }

      if ('isFirstSubsequentAuth' in obj && obj.isFirstSubsequentAuth != null) {
        this.setIsFirstSubsequentAuth(obj.isFirstSubsequentAuth);
      }

      if ('isSubsequentAuth' in obj && obj.isSubsequentAuth != null) {
        this.setIsSubsequentAuth(obj.isSubsequentAuth);
      }

      if ('isStoredCredentials' in obj && obj.isStoredCredentials != null) {
        this.setIsStoredCredentials(obj.isStoredCredentials);
      }
    } else {
    ...
    _logger.logger.debug('Exit ProcessingOptions constructor');
  }

  setIsFirstRecurringPayment(p_isFirstRecurringPayment) {
    this.isFirstRecurringPayment = p_isFirstRecurringPayment;
  }

  getIsFirstRecurringPayment() {
    if ('isFirstRecurringPayment' in this) {
      return this.isFirstRecurringPayment;
    }
  }

  setIsFirstSubsequentAuth(p_isFirstSubsequentAuth) {
    this.isFirstSubsequentAuth = p_isFirstSubsequentAuth;
  }

  getIsFirstSubsequentAuth() {
    if ('isFirstSubsequentAuth' in this) {
      return this.isFirstSubsequentAuth;
    }
  }

  setIsSubsequentAuth(p_isSubsequentAuth) {
    this.isSubsequentAuth = p_isSubsequentAuth;
  }

  getIsSubsequentAuth() {
    if ('isSubsequentAuth' in this) {
      return this.isSubsequentAuth;
    }
  }

  setIsStoredCredentials(p_isStoredCredentials) {
    this.isStoredCredentials = p_isStoredCredentials;
  }

  getIsStoredCredentials() {
    if ('isStoredCredentials' in this) {
...
class ProcessorType {
  constructor(obj) {
    _logger.logger.debug('Enter ProcessorType constructor');
    ...
    _logger.logger.debug('Exit ProcessorType constructor');
  }
...
class ProfileTransAmountType {
  constructor(obj) {
    _logger.logger.debug('Enter ProfileTransAmountType constructor');
    ...
    _logger.logger.debug('Exit ProfileTransAmountType constructor');
  }
...
class ProfileTransVoidType {
  constructor(obj) {
    _logger.logger.debug('Enter ProfileTransVoidType constructor');
    ...
    _logger.logger.debug('Exit ProfileTransVoidType constructor');
  }
...
class ProfileTransactionType {
  constructor(obj) {
    _logger.logger.debug('Enter ProfileTransactionType constructor');
    ...
    _logger.logger.debug('Exit ProfileTransactionType constructor');
  }
...
class ReturnedItemType {
  constructor(obj) {
    _logger.logger.debug('Enter ReturnedItemType constructor');
    ...
    _logger.logger.debug('Exit ReturnedItemType constructor');
  }
...
class SecurePaymentContainerErrorType {
  constructor(obj) {
    _logger.logger.debug('Enter SecurePaymentContainerErrorType constructor');
    ...
    _logger.logger.debug('Exit SecurePaymentContainerErrorType constructor');
  }
...
class SettingType {
  constructor(obj) {
    _logger.logger.debug('Enter SettingType constructor');
    ...
    _logger.logger.debug('Exit SettingType constructor');
  }
...
class SolutionType {
  constructor(obj) {
    _logger.logger.debug('Enter SolutionType constructor');
    ...
    _logger.logger.debug('Exit SolutionType constructor');
  }
...
class SubMerchantType {
  constructor(obj) {
    _logger.logger.debug('Enter SubMerchantType constructor');
    ...
    _logger.logger.debug('Exit SubMerchantType constructor');
  }
  ...
  setDoingBusinessAs(p_doingBusinessAs) {
  ...
  setPaymentServiceProviderName(p_paymentServiceProviderName) {
  ...
  setPaymentServiceFacilitator(p_paymentServiceFacilitator) {
  ...
  setStreetAddress(p_streetAddress) {
...
class SubscriptionDetail {
  constructor(obj) {
    _logger.logger.debug('Enter SubscriptionDetail constructor');
    ...
    _logger.logger.debug('Exit SubscriptionDetail constructor');
  }
...
class SubscriptionIdList {
  constructor(obj) {
    _logger.logger.debug('Enter SubscriptionIdList constructor');
    ...
    _logger.logger.debug('Exit SubscriptionIdList constructor');
  }
...
class SubscriptionPaymentType {
  constructor(obj) {
    _logger.logger.debug('Enter SubscriptionPaymentType constructor');
    ...
    _logger.logger.debug('Exit SubscriptionPaymentType constructor');
  }
...
class SubsequentAuthInformation {
  constructor(obj) {
    _logger.logger.debug('Enter SubsequentAuthInformation constructor');

    if (arguments.length == 1) {
      if ('originalNetworkTransId' in obj && obj.originalNetworkTransId != null) {
        this.setOriginalNetworkTransId(obj.originalNetworkTransId);
      }

      if ('reason' in obj && obj.reason != null) {
        this.setReason(obj.reason);
      }
    } else {
    ...
    _logger.logger.debug('Exit SubsequentAuthInformation constructor');
  }

  setOriginalNetworkTransId(p_originalNetworkTransId) {
    this.originalNetworkTransId = p_originalNetworkTransId;
  }

  getOriginalNetworkTransId() {
    if ('originalNetworkTransId' in this) {
...
class TokenMaskedType {
  constructor(obj) {
    _logger.logger.debug('Enter TokenMaskedType constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('tokenRequestorId' in obj && obj.tokenRequestorId != null) {
        this.setTokenRequestorId(obj.tokenRequestorId);
      }
    } else {
    ...
    _logger.logger.debug('Exit TokenMaskedType constructor');
  }
  ...
  setTokenRequestorId(p_tokenRequestorId) {
    this.tokenRequestorId = p_tokenRequestorId;
  }

  getTokenRequestorId() {
    if ('tokenRequestorId' in this) {
...
class TransRetailInfoType {
  constructor(obj) {
    _logger.logger.debug('Enter TransRetailInfoType constructor');
    ...
    _logger.logger.debug('Exit TransRetailInfoType constructor');
  }
...
class TransactionDetailsType {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionDetailsType constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('otherTax' in obj && obj.otherTax != null) {
        this.setOtherTax(new OtherTaxType(obj.otherTax));
      }

      if ('shipFrom' in obj && obj.shipFrom != null) {
        this.setShipFrom(new NameAndAddressType(obj.shipFrom));
      }
    } else {
      this.setTransId(null);
      this.setRefTransId(null);
    ...
    _logger.logger.debug('Exit TransactionDetailsType constructor');
  }
  ...
  setOtherTax(p_otherTax) {
    this.otherTax = p_otherTax;
  }
  ...
  setShipFrom(p_shipFrom) {
    this.shipFrom = p_shipFrom;
  }
...
class TransactionListSorting {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionListSorting constructor');
    ...
    _logger.logger.debug('Exit TransactionListSorting constructor');
  }
...
class TransactionRequestType {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionRequestType constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('processingOptions' in obj && obj.processingOptions != null) {
        this.setProcessingOptions(new ProcessingOptions(obj.processingOptions));
      }

      if ('subsequentAuthInformation' in obj && obj.subsequentAuthInformation != null) {
        this.setSubsequentAuthInformation(new SubsequentAuthInformation(obj.subsequentAuthInformation));
      }
    ...
    _logger.logger.debug('Exit TransactionRequestType constructor');
  }
  ...
  setMerchantDescriptor(p_merchantDescriptor) {
  ...
  setProcessingOptions(p_processingOptions) {
    this.processingOptions = p_processingOptions;
  }

  getProcessingOptions() {
    if ('processingOptions' in this) {
      return this.processingOptions;
    }
  }

  setSubsequentAuthInformation(p_subsequentAuthInformation) {
    this.subsequentAuthInformation = p_subsequentAuthInformation;
  }

  getSubsequentAuthInformation() {
    if ('subsequentAuthInformation' in this) {
...
class TransactionResponse {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionResponse constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('networkTransId' in obj && obj.networkTransId != null) {
        this.setNetworkTransId(obj.networkTransId);
      }
    } else {
      this.setResponseCode(null);
    ...
    _logger.logger.debug('Exit TransactionResponse constructor');
  }
  ...
  setTransHashSha2(p_transHashSha2) {
  ...
  setNetworkTransId(p_networkTransId) {
    this.networkTransId = p_networkTransId;
  }

  getNetworkTransId() {
    if ('networkTransId' in this) {
...
class TransactionSummaryType {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionSummaryType constructor');
    ...
    _logger.logger.debug('Exit TransactionSummaryType constructor');
  }
  ...
  setFraudInformation(p_fraudInformation) {
...
class UserField {
  constructor(obj) {
    _logger.logger.debug('Enter UserField constructor');
    ...
    _logger.logger.debug('Exit UserField constructor');
  }
...
class WebCheckOutDataType {
  constructor(obj) {
    _logger.logger.debug('Enter WebCheckOutDataType constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('token' in obj && obj.token != null) {
        this.setToken(new WebCheckOutDataTypeToken(obj.token));
      }

      if ('bankToken' in obj && obj.bankToken != null) {
        this.setBankToken(new BankAccountType(obj.bankToken));
      }
    } else {
      this.setType(null);
      this.setId(null);
    ...
    _logger.logger.debug('Exit WebCheckOutDataType constructor');
  }
  ...
  setBankToken(p_bankToken) {
    this.bankToken = p_bankToken;
  }

  getBankToken() {
    if ('bankToken' in this) {
...
class WebCheckOutDataTypeToken {
  constructor(obj) {
    _logger.logger.debug('Enter WebCheckOutDataTypeToken constructor');
    ...
    _logger.logger.debug('Exit WebCheckOutDataTypeToken constructor');
  }
...
KeyManagementScheme.DUKPT = class {
  constructor(obj) {
    _logger.logger.debug('Enter KeyManagementScheme.DUKPT constructor');
    ...
    _logger.logger.debug('Exit KeyManagementScheme.DUKPT constructor');
  }
...
MessagesType.Message = class {
  constructor(obj) {
    _logger.logger.debug('Enter MessagesType.Message constructor');
    ...
    _logger.logger.debug('Exit MessagesType.Message constructor');
  }
...
PaymentScheduleType.Interval = class {
  constructor(obj) {
    _logger.logger.debug('Enter PaymentScheduleType.Interval constructor');
    ...
    _logger.logger.debug('Exit PaymentScheduleType.Interval constructor');
  }
...
TransactionDetailsType.EmvDetails = class {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionDetailsType.EmvDetails constructor');
    ...
    _logger.logger.debug('Exit TransactionDetailsType.EmvDetails constructor');
  }
...
TransactionRequestType.UserFields = class {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionRequestType.UserFields constructor');
    ...
    _logger.logger.debug('Exit TransactionRequestType.UserFields constructor');
  }
...
TransactionResponse.EmvResponse = class {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionResponse.EmvResponse constructor');
    ...
    _logger.logger.debug('Exit TransactionResponse.EmvResponse constructor');
  }
...
TransactionResponse.Errors = class {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionResponse.Errors constructor');
    ...
    _logger.logger.debug('Exit TransactionResponse.Errors constructor');
  }
...
TransactionResponse.Messages = class {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionResponse.Messages constructor');
    ...
    _logger.logger.debug('Exit TransactionResponse.Messages constructor');
  }
...
TransactionResponse.PrePaidCard = class {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionResponse.PrePaidCard constructor');
    ...
    _logger.logger.debug('Exit TransactionResponse.PrePaidCard constructor');
  }
...
TransactionResponse.SecureAcceptance = class {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionResponse.SecureAcceptance constructor');
    ...
    _logger.logger.debug('Exit TransactionResponse.SecureAcceptance constructor');
  }
...
TransactionResponse.SplitTenderPayments = class {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionResponse.SplitTenderPayments constructor');
    ...
    _logger.logger.debug('Exit TransactionResponse.SplitTenderPayments constructor');
  }
...
TransactionResponse.UserFields = class {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionResponse.UserFields constructor');
    ...
    _logger.logger.debug('Exit TransactionResponse.UserFields constructor');
  }
...
KeyManagementScheme.DUKPT.DeviceInfo = class {
  constructor(obj) {
    _logger.logger.debug('Enter KeyManagementScheme.DUKPT.DeviceInfo constructor');
    ...
    _logger.logger.debug('Exit KeyManagementScheme.DUKPT.DeviceInfo constructor');
  }
...
KeyManagementScheme.DUKPT.EncryptedData = class {
  constructor(obj) {
    _logger.logger.debug('Enter KeyManagementScheme.DUKPT.EncryptedData constructor');
    ...
    _logger.logger.debug('Exit KeyManagementScheme.DUKPT.EncryptedData constructor');
  }
...
KeyManagementScheme.DUKPT.Mode = class {
  constructor(obj) {
    _logger.logger.debug('Enter KeyManagementScheme.DUKPT.Mode constructor');
    ...
    _logger.logger.debug('Exit KeyManagementScheme.DUKPT.Mode constructor');
  }
...
TransactionDetailsType.EmvDetails.Tag = class {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionDetailsType.EmvDetails.Tag constructor');
    ...
    _logger.logger.debug('Exit TransactionDetailsType.EmvDetails.Tag constructor');
  }
...
TransactionResponse.EmvResponse.Tags = class {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionResponse.EmvResponse.Tags constructor');
    ...
    _logger.logger.debug('Exit TransactionResponse.EmvResponse.Tags constructor');
  }
...
TransactionResponse.Errors.Error = class {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionResponse.Errors.Error constructor');
    ...
    _logger.logger.debug('Exit TransactionResponse.Errors.Error constructor');
  }
...
TransactionResponse.Messages.Message = class {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionResponse.Messages.Message constructor');
    ...
    _logger.logger.debug('Exit TransactionResponse.Messages.Message constructor');
  }
...
TransactionResponse.SplitTenderPayments.SplitTenderPayment = class {
  constructor(obj) {
    _logger.logger.debug('Enter TransactionResponse.SplitTenderPayments.SplitTenderPayment constructor');
    ...
    _logger.logger.debug('Exit TransactionResponse.SplitTenderPayments.SplitTenderPayment constructor');
  }
...
class ARBCancelSubscriptionRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter ARBCancelSubscriptionRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'ARBCancelSubscriptionRequest': this
    };

    _logger.logger.debug('Exit ARBCancelSubscriptionRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter ARBCancelSubscriptionRequest constructor');
    ...
    _logger.logger.debug('Exit ARBCancelSubscriptionRequest constructor');
  }
...
class ARBCancelSubscriptionResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter ARBCancelSubscriptionResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'ARBCancelSubscriptionResponse': this
    };

    _logger.logger.debug('Exit ARBCancelSubscriptionResponse getJSON');
...
class ARBCreateSubscriptionRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter ARBCreateSubscriptionRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'ARBCreateSubscriptionRequest': this
    };

    _logger.logger.debug('Exit ARBCreateSubscriptionRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter ARBCreateSubscriptionRequest constructor');
    ...
    _logger.logger.debug('Exit ARBCreateSubscriptionRequest constructor');
  }
...
class ARBCreateSubscriptionResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter ARBCreateSubscriptionResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'ARBCreateSubscriptionResponse': this
    };

    _logger.logger.debug('Exit ARBCreateSubscriptionResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter ARBCreateSubscriptionResponse constructor');
    ...
    _logger.logger.debug('Exit ARBCreateSubscriptionResponse constructor');
  }
...
class ARBGetSubscriptionListRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter ARBGetSubscriptionListRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'ARBGetSubscriptionListRequest': this
    };

    _logger.logger.debug('Exit ARBGetSubscriptionListRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter ARBGetSubscriptionListRequest constructor');
    ...
    _logger.logger.debug('Exit ARBGetSubscriptionListRequest constructor');
  }
...
class ARBGetSubscriptionListResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter ARBGetSubscriptionListResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'ARBGetSubscriptionListResponse': this
    };

    _logger.logger.debug('Exit ARBGetSubscriptionListResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter ARBGetSubscriptionListResponse constructor');
    ...
    _logger.logger.debug('Exit ARBGetSubscriptionListResponse constructor');
  }
...
class ARBGetSubscriptionRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter ARBGetSubscriptionRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'ARBGetSubscriptionRequest': this
    };

    _logger.logger.debug('Exit ARBGetSubscriptionRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter ARBGetSubscriptionRequest constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('includeTransactions' in obj && obj.includeTransactions != null) {
        this.setIncludeTransactions(obj.includeTransactions);
      }
    } else {
      super();
      this.setSubscriptionId(null);
    ...
    _logger.logger.debug('Exit ARBGetSubscriptionRequest constructor');
  }
  ...
  setIncludeTransactions(p_includeTransactions) {
...
class ARBGetSubscriptionResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter ARBGetSubscriptionResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'ARBGetSubscriptionResponse': this
    };

    _logger.logger.debug('Exit ARBGetSubscriptionResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter ARBGetSubscriptionResponse constructor');
    ...
    _logger.logger.debug('Exit ARBGetSubscriptionResponse constructor');
  }
...
class ARBGetSubscriptionStatusRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter ARBGetSubscriptionStatusRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'ARBGetSubscriptionStatusRequest': this
    };

    _logger.logger.debug('Exit ARBGetSubscriptionStatusRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter ARBGetSubscriptionStatusRequest constructor');
    ...
    _logger.logger.debug('Exit ARBGetSubscriptionStatusRequest constructor');
  }
...
class ARBGetSubscriptionStatusResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter ARBGetSubscriptionStatusResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'ARBGetSubscriptionStatusResponse': this
    };

    _logger.logger.debug('Exit ARBGetSubscriptionStatusResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter ARBGetSubscriptionStatusResponse constructor');
    ...
    _logger.logger.debug('Exit ARBGetSubscriptionStatusResponse constructor');
  }
...
class ARBUpdateSubscriptionRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter ARBUpdateSubscriptionRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'ARBUpdateSubscriptionRequest': this
    };

    _logger.logger.debug('Exit ARBUpdateSubscriptionRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter ARBUpdateSubscriptionRequest constructor');
    ...
    _logger.logger.debug('Exit ARBUpdateSubscriptionRequest constructor');
  }
...
class ARBUpdateSubscriptionResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter ARBUpdateSubscriptionResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'ARBUpdateSubscriptionResponse': this
    };

    _logger.logger.debug('Exit ARBUpdateSubscriptionResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter ARBUpdateSubscriptionResponse constructor');
    ...
    _logger.logger.debug('Exit ARBUpdateSubscriptionResponse constructor');
  }
...
class AuDeleteType extends AuDetailsType {
  constructor(obj) {
    _logger.logger.debug('Enter AuDeleteType constructor');
    ...
    _logger.logger.debug('Exit AuDeleteType constructor');
  }
...
class AuUpdateType extends AuDetailsType {
  constructor(obj) {
    _logger.logger.debug('Enter AuUpdateType constructor');
    ...
    _logger.logger.debug('Exit AuUpdateType constructor');
  }
...
class AuthenticateTestRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter AuthenticateTestRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'authenticateTestRequest': this
    };

    _logger.logger.debug('Exit AuthenticateTestRequest getJSON');
...
class AuthenticateTestResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter AuthenticateTestResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'authenticateTestResponse': this
    };

    _logger.logger.debug('Exit AuthenticateTestResponse getJSON');
...
class CreateCustomerPaymentProfileRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter CreateCustomerPaymentProfileRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'createCustomerPaymentProfileRequest': this
    };

    _logger.logger.debug('Exit CreateCustomerPaymentProfileRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter CreateCustomerPaymentProfileRequest constructor');
    ...
    _logger.logger.debug('Exit CreateCustomerPaymentProfileRequest constructor');
  }
...
class CreateCustomerPaymentProfileResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter CreateCustomerPaymentProfileResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'createCustomerPaymentProfileResponse': this
    };

    _logger.logger.debug('Exit CreateCustomerPaymentProfileResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter CreateCustomerPaymentProfileResponse constructor');
    ...
    _logger.logger.debug('Exit CreateCustomerPaymentProfileResponse constructor');
  }
...
class CreateCustomerProfileFromTransactionRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter CreateCustomerProfileFromTransactionRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'createCustomerProfileFromTransactionRequest': this
    };

    _logger.logger.debug('Exit CreateCustomerProfileFromTransactionRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter CreateCustomerProfileFromTransactionRequest constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('defaultShippingAddress' in obj && obj.defaultShippingAddress != null) {
        this.setDefaultShippingAddress(obj.defaultShippingAddress);
      }

      if ('profileType' in obj && obj.profileType != null) {
        this.setProfileType(obj.profileType);
      }
    } else {
      super();
      this.setTransId(null);
    ...
    _logger.logger.debug('Exit CreateCustomerProfileFromTransactionRequest constructor');
  }
  ...
  setDefaultShippingAddress(p_defaultShippingAddress) {
  ...
  setProfileType(p_profileType) {
    this.profileType = p_profileType;
  }

  getProfileType() {
    if ('profileType' in this) {
...
class CreateCustomerProfileRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter CreateCustomerProfileRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'createCustomerProfileRequest': this
    };

    _logger.logger.debug('Exit CreateCustomerProfileRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter CreateCustomerProfileRequest constructor');
    ...
    _logger.logger.debug('Exit CreateCustomerProfileRequest constructor');
  }
...
class CreateCustomerProfileResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter CreateCustomerProfileResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'createCustomerProfileResponse': this
    };

    _logger.logger.debug('Exit CreateCustomerProfileResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter CreateCustomerProfileResponse constructor');
    ...
    _logger.logger.debug('Exit CreateCustomerProfileResponse constructor');
  }
...
class CreateCustomerProfileTransactionRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter CreateCustomerProfileTransactionRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'createCustomerProfileTransactionRequest': this
    };

    _logger.logger.debug('Exit CreateCustomerProfileTransactionRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter CreateCustomerProfileTransactionRequest constructor');
    ...
    _logger.logger.debug('Exit CreateCustomerProfileTransactionRequest constructor');
  }
...
class CreateCustomerProfileTransactionResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter CreateCustomerProfileTransactionResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'createCustomerProfileTransactionResponse': this
    };

    _logger.logger.debug('Exit CreateCustomerProfileTransactionResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter CreateCustomerProfileTransactionResponse constructor');
    ...
    _logger.logger.debug('Exit CreateCustomerProfileTransactionResponse constructor');
  }
...
class CreateCustomerShippingAddressRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter CreateCustomerShippingAddressRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'createCustomerShippingAddressRequest': this
    };

    _logger.logger.debug('Exit CreateCustomerShippingAddressRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter CreateCustomerShippingAddressRequest constructor');
    ...
    _logger.logger.debug('Exit CreateCustomerShippingAddressRequest constructor');
  }
...
class CreateCustomerShippingAddressResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter CreateCustomerShippingAddressResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'createCustomerShippingAddressResponse': this
    };

    _logger.logger.debug('Exit CreateCustomerShippingAddressResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter CreateCustomerShippingAddressResponse constructor');
    ...
    _logger.logger.debug('Exit CreateCustomerShippingAddressResponse constructor');
  }
...
class CreateTransactionRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter CreateTransactionRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'createTransactionRequest': this
    };

    _logger.logger.debug('Exit CreateTransactionRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter CreateTransactionRequest constructor');
    ...
    _logger.logger.debug('Exit CreateTransactionRequest constructor');
  }
...
class CreateTransactionResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter CreateTransactionResponse getJSON');
    ...
    _logger.logger.debug('Exit CreateTransactionResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter CreateTransactionResponse constructor');
    ...
    _logger.logger.debug('Exit CreateTransactionResponse constructor');
  }
...
class CreditCardType extends CreditCardSimpleType {
  constructor(obj) {
    _logger.logger.debug('Enter CreditCardType constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('tokenRequestorName' in obj && obj.tokenRequestorName != null) {
        this.setTokenRequestorName(obj.tokenRequestorName);
      }
      ...
      if ('tokenRequestorEci' in obj && obj.tokenRequestorEci != null) {
        this.setTokenRequestorEci(obj.tokenRequestorEci);
      }
    } else {
      super();
      this.setCardCode(null);
    ...
    _logger.logger.debug('Exit CreditCardType constructor');
  }
  ...
  setTokenRequestorName(p_tokenRequestorName) {
    this.tokenRequestorName = p_tokenRequestorName;
  }

  getTokenRequestorName() {
    if ('tokenRequestorName' in this) {
  ...
  setTokenRequestorEci(p_tokenRequestorEci) {
    this.tokenRequestorEci = p_tokenRequestorEci;
  }

  getTokenRequestorEci() {
    if ('tokenRequestorEci' in this) {
...
class CustomerAddressType extends NameAndAddressType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerAddressType constructor');
    ...
    _logger.logger.debug('Exit CustomerAddressType constructor');
  }
...
class CustomerPaymentProfileMaskedType extends CustomerPaymentProfileBaseType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerPaymentProfileMaskedType constructor');
    ...
    _logger.logger.debug('Exit CustomerPaymentProfileMaskedType constructor');
  }
...
class CustomerPaymentProfileType extends CustomerPaymentProfileBaseType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerPaymentProfileType constructor');
    ...
    _logger.logger.debug('Exit CustomerPaymentProfileType constructor');
  }
...
class CustomerProfileExType extends CustomerProfileBaseType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerProfileExType constructor');
    ...
    _logger.logger.debug('Exit CustomerProfileExType constructor');
  }
...
class CustomerProfileType extends CustomerProfileBaseType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerProfileType constructor');
    ...
    _logger.logger.debug('Exit CustomerProfileType constructor');
  }
...
class DecryptPaymentDataRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter DecryptPaymentDataRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'decryptPaymentDataRequest': this
    };

    _logger.logger.debug('Exit DecryptPaymentDataRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter DecryptPaymentDataRequest constructor');
    ...
    _logger.logger.debug('Exit DecryptPaymentDataRequest constructor');
  }
...
class DecryptPaymentDataResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter DecryptPaymentDataResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'decryptPaymentDataResponse': this
    };

    _logger.logger.debug('Exit DecryptPaymentDataResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter DecryptPaymentDataResponse constructor');
    ...
    _logger.logger.debug('Exit DecryptPaymentDataResponse constructor');
  }
...
class DeleteCustomerPaymentProfileRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter DeleteCustomerPaymentProfileRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'deleteCustomerPaymentProfileRequest': this
    };

    _logger.logger.debug('Exit DeleteCustomerPaymentProfileRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter DeleteCustomerPaymentProfileRequest constructor');
    ...
    _logger.logger.debug('Exit DeleteCustomerPaymentProfileRequest constructor');
  }
...
class DeleteCustomerPaymentProfileResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter DeleteCustomerPaymentProfileResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'deleteCustomerPaymentProfileResponse': this
    };

    _logger.logger.debug('Exit DeleteCustomerPaymentProfileResponse getJSON');
...
class DeleteCustomerProfileRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter DeleteCustomerProfileRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'deleteCustomerProfileRequest': this
    };

    _logger.logger.debug('Exit DeleteCustomerProfileRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter DeleteCustomerProfileRequest constructor');
    ...
    _logger.logger.debug('Exit DeleteCustomerProfileRequest constructor');
  }
...
class DeleteCustomerProfileResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter DeleteCustomerProfileResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'deleteCustomerProfileResponse': this
    };

    _logger.logger.debug('Exit DeleteCustomerProfileResponse getJSON');
...
class DeleteCustomerShippingAddressRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter DeleteCustomerShippingAddressRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'deleteCustomerShippingAddressRequest': this
    };

    _logger.logger.debug('Exit DeleteCustomerShippingAddressRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter DeleteCustomerShippingAddressRequest constructor');
    ...
    _logger.logger.debug('Exit DeleteCustomerShippingAddressRequest constructor');
  }
...
class DeleteCustomerShippingAddressResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter DeleteCustomerShippingAddressResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'deleteCustomerShippingAddressResponse': this
    };

    _logger.logger.debug('Exit DeleteCustomerShippingAddressResponse getJSON');
...
class EmailSettingsType extends ArrayOfSetting {
  constructor(obj) {
    _logger.logger.debug('Enter EmailSettingsType constructor');
    ...
    _logger.logger.debug('Exit EmailSettingsType constructor');
  }
...
class GetAUJobDetailsRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetAUJobDetailsRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getAUJobDetailsRequest': this
    };

    _logger.logger.debug('Exit GetAUJobDetailsRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetAUJobDetailsRequest constructor');
    ...
    _logger.logger.debug('Exit GetAUJobDetailsRequest constructor');
  }
...
class GetAUJobDetailsResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetAUJobDetailsResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getAUJobDetailsResponse': this
    };

    _logger.logger.debug('Exit GetAUJobDetailsResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetAUJobDetailsResponse constructor');
    ...
    _logger.logger.debug('Exit GetAUJobDetailsResponse constructor');
  }
...
class GetAUJobSummaryRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetAUJobSummaryRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getAUJobSummaryRequest': this
    };

    _logger.logger.debug('Exit GetAUJobSummaryRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetAUJobSummaryRequest constructor');
    ...
    _logger.logger.debug('Exit GetAUJobSummaryRequest constructor');
  }
...
class GetAUJobSummaryResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetAUJobSummaryResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getAUJobSummaryResponse': this
    };

    _logger.logger.debug('Exit GetAUJobSummaryResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetAUJobSummaryResponse constructor');
    ...
    _logger.logger.debug('Exit GetAUJobSummaryResponse constructor');
  }
...
class GetBatchStatisticsRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetBatchStatisticsRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getBatchStatisticsRequest': this
    };

    _logger.logger.debug('Exit GetBatchStatisticsRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetBatchStatisticsRequest constructor');
    ...
    _logger.logger.debug('Exit GetBatchStatisticsRequest constructor');
  }
...
class GetBatchStatisticsResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetBatchStatisticsResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getBatchStatisticsResponse': this
    };

    _logger.logger.debug('Exit GetBatchStatisticsResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetBatchStatisticsResponse constructor');
    ...
    _logger.logger.debug('Exit GetBatchStatisticsResponse constructor');
  }
...
class GetCustomerPaymentProfileListRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetCustomerPaymentProfileListRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getCustomerPaymentProfileListRequest': this
    };

    _logger.logger.debug('Exit GetCustomerPaymentProfileListRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetCustomerPaymentProfileListRequest constructor');
    ...
    _logger.logger.debug('Exit GetCustomerPaymentProfileListRequest constructor');
  }
...
class GetCustomerPaymentProfileListResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetCustomerPaymentProfileListResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getCustomerPaymentProfileListResponse': this
    };

    _logger.logger.debug('Exit GetCustomerPaymentProfileListResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetCustomerPaymentProfileListResponse constructor');
    ...
    _logger.logger.debug('Exit GetCustomerPaymentProfileListResponse constructor');
  }
...
class GetCustomerPaymentProfileNonceRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetCustomerPaymentProfileNonceRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getCustomerPaymentProfileNonceRequest': this
    };

    _logger.logger.debug('Exit GetCustomerPaymentProfileNonceRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetCustomerPaymentProfileNonceRequest constructor');

    if (arguments.length == 1) {
      super(obj);

      if ('connectedAccessToken' in obj && obj.connectedAccessToken != null) {
        this.setConnectedAccessToken(obj.connectedAccessToken);
      }
    ...
    _logger.logger.debug('Exit GetCustomerPaymentProfileNonceRequest constructor');
  }

  setConnectedAccessToken(p_connectedAccessToken) {
    this.connectedAccessToken = p_connectedAccessToken;
  }

  getConnectedAccessToken() {
    if ('connectedAccessToken' in this) {
...
class GetCustomerPaymentProfileNonceResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetCustomerPaymentProfileNonceResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getCustomerPaymentProfileNonceResponse': this
    };

    _logger.logger.debug('Exit GetCustomerPaymentProfileNonceResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetCustomerPaymentProfileNonceResponse constructor');
    ...
    _logger.logger.debug('Exit GetCustomerPaymentProfileNonceResponse constructor');
  }
...
class GetCustomerPaymentProfileRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetCustomerPaymentProfileRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getCustomerPaymentProfileRequest': this
    };

    _logger.logger.debug('Exit GetCustomerPaymentProfileRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetCustomerPaymentProfileRequest constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('includeIssuerInfo' in obj && obj.includeIssuerInfo != null) {
        this.setIncludeIssuerInfo(obj.includeIssuerInfo);
      }
    } else {
      super();
      this.setCustomerProfileId(null);
    ...
    _logger.logger.debug('Exit GetCustomerPaymentProfileRequest constructor');
  }
  ...
  setIncludeIssuerInfo(p_includeIssuerInfo) {
...
class GetCustomerPaymentProfileResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetCustomerPaymentProfileResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getCustomerPaymentProfileResponse': this
    };

    _logger.logger.debug('Exit GetCustomerPaymentProfileResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetCustomerPaymentProfileResponse constructor');
    ...
    _logger.logger.debug('Exit GetCustomerPaymentProfileResponse constructor');
  }
...
class GetCustomerProfileIdsRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetCustomerProfileIdsRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getCustomerProfileIdsRequest': this
    };

    _logger.logger.debug('Exit GetCustomerProfileIdsRequest getJSON');
...
class GetCustomerProfileIdsResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetCustomerProfileIdsResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getCustomerProfileIdsResponse': this
    };

    _logger.logger.debug('Exit GetCustomerProfileIdsResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetCustomerProfileIdsResponse constructor');
    ...
    _logger.logger.debug('Exit GetCustomerProfileIdsResponse constructor');
  }
...
class GetCustomerProfileRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetCustomerProfileRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getCustomerProfileRequest': this
    };

    _logger.logger.debug('Exit GetCustomerProfileRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetCustomerProfileRequest constructor');
    ...
    _logger.logger.debug('Exit GetCustomerProfileRequest constructor');
  }
...
class GetCustomerProfileResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetCustomerProfileResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getCustomerProfileResponse': this
    };

    _logger.logger.debug('Exit GetCustomerProfileResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetCustomerProfileResponse constructor');
    ...
    _logger.logger.debug('Exit GetCustomerProfileResponse constructor');
  }
...
class GetCustomerShippingAddressRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetCustomerShippingAddressRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getCustomerShippingAddressRequest': this
    };

    _logger.logger.debug('Exit GetCustomerShippingAddressRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetCustomerShippingAddressRequest constructor');
    ...
    _logger.logger.debug('Exit GetCustomerShippingAddressRequest constructor');
  }
...
class GetCustomerShippingAddressResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetCustomerShippingAddressResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getCustomerShippingAddressResponse': this
    };

    _logger.logger.debug('Exit GetCustomerShippingAddressResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetCustomerShippingAddressResponse constructor');
    ...
    _logger.logger.debug('Exit GetCustomerShippingAddressResponse constructor');
  }
...
class GetHostedPaymentPageRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetHostedPaymentPageRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getHostedPaymentPageRequest': this
    };

    _logger.logger.debug('Exit GetHostedPaymentPageRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetHostedPaymentPageRequest constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('hostedPaymentSettings' in obj && obj.hostedPaymentSettings != null) {
        this.setHostedPaymentSettings(new ArrayOfSetting(obj.hostedPaymentSettings));
      }
    } else {
      super();
      this.setTransactionRequest(null);
    ...
    _logger.logger.debug('Exit GetHostedPaymentPageRequest constructor');
  }
  ...
  setHostedPaymentSettings(p_hostedPaymentSettings) {
...
class GetHostedPaymentPageResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetHostedPaymentPageResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getHostedPaymentPageResponse': this
    };

    _logger.logger.debug('Exit GetHostedPaymentPageResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetHostedPaymentPageResponse constructor');
    ...
    _logger.logger.debug('Exit GetHostedPaymentPageResponse constructor');
  }
...
class GetHostedProfilePageRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetHostedProfilePageRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getHostedProfilePageRequest': this
    };

    _logger.logger.debug('Exit GetHostedProfilePageRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetHostedProfilePageRequest constructor');
    ...
    _logger.logger.debug('Exit GetHostedProfilePageRequest constructor');
  }
...
class GetHostedProfilePageResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetHostedProfilePageResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getHostedProfilePageResponse': this
    };

    _logger.logger.debug('Exit GetHostedProfilePageResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetHostedProfilePageResponse constructor');
    ...
    _logger.logger.debug('Exit GetHostedProfilePageResponse constructor');
  }
...
class GetMerchantDetailsRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetMerchantDetailsRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getMerchantDetailsRequest': this
    };

    _logger.logger.debug('Exit GetMerchantDetailsRequest getJSON');
...
class GetMerchantDetailsResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetMerchantDetailsResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getMerchantDetailsResponse': this
    };

    _logger.logger.debug('Exit GetMerchantDetailsResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetMerchantDetailsResponse constructor');

    if (arguments.length == 1) {
      super(obj);

      if ('isTestMode' in obj && obj.isTestMode != null) {
        this.setIsTestMode(obj.isTestMode);
      }

      if ('processors' in obj && obj.processors != null) {
        this.setProcessors(new ArrayOfProcessorType(obj.processors));
      }
      ...
      if ('gatewayId' in obj && obj.gatewayId != null) {
        this.setGatewayId(obj.gatewayId);
      }

      if ('marketTypes' in obj && obj.marketTypes != null) {
        this.setMarketTypes(new ArrayOfMarketType(obj.marketTypes));
      }

      if ('productCodes' in obj && obj.productCodes != null) {
        this.setProductCodes(new ArrayOfProductCode(obj.productCodes));
      }

      if ('paymentMethods' in obj && obj.paymentMethods != null) {
        this.setPaymentMethods(new ArrayOfPaymentMethod(obj.paymentMethods));
      }

      if ('currencies' in obj && obj.currencies != null) {
        this.setCurrencies(new ArrayOfCurrencyCode(obj.currencies));
      }

      if ('publicClientKey' in obj && obj.publicClientKey != null) {
        this.setPublicClientKey(obj.publicClientKey);
      }

      if ('businessInformation' in obj && obj.businessInformation != null) {
        this.setBusinessInformation(new CustomerAddressType(obj.businessInformation));
      }

      if ('merchantTimeZone' in obj && obj.merchantTimeZone != null) {
        this.setMerchantTimeZone(obj.merchantTimeZone);
      }

      if ('contactDetails' in obj && obj.contactDetails != null) {
        this.setContactDetails(new ArrayOfContactDetail(obj.contactDetails));
      }
    } else {
      super();
    ...
    _logger.logger.debug('Exit GetMerchantDetailsResponse constructor');
  }

  setIsTestMode(p_isTestMode) {
  ...
  setProductCodes(p_productCodes) {
  ...
  setPaymentMethods(p_paymentMethods) {
  ...
  setPublicClientKey(p_publicClientKey) {
  ...
  setBusinessInformation(p_businessInformation) {
    this.businessInformation = p_businessInformation;
  }

  getBusinessInformation() {
    if ('businessInformation' in this) {
      return this.businessInformation;
    }
  }

  setMerchantTimeZone(p_merchantTimeZone) {
    this.merchantTimeZone = p_merchantTimeZone;
  }

  getMerchantTimeZone() {
    if ('merchantTimeZone' in this) {
      return this.merchantTimeZone;
    }
  }

  setContactDetails(p_contactDetails) {
    this.contactDetails = p_contactDetails;
  }

  getContactDetails() {
    if ('contactDetails' in this) {
...
class GetSettledBatchListRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetSettledBatchListRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getSettledBatchListRequest': this
    };

    _logger.logger.debug('Exit GetSettledBatchListRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetSettledBatchListRequest constructor');
    ...
    _logger.logger.debug('Exit GetSettledBatchListRequest constructor');
  }
...
class GetSettledBatchListResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetSettledBatchListResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getSettledBatchListResponse': this
    };

    _logger.logger.debug('Exit GetSettledBatchListResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetSettledBatchListResponse constructor');
    ...
    _logger.logger.debug('Exit GetSettledBatchListResponse constructor');
  }
...
class GetTransactionDetailsRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetTransactionDetailsRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getTransactionDetailsRequest': this
    };

    _logger.logger.debug('Exit GetTransactionDetailsRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetTransactionDetailsRequest constructor');
    ...
    _logger.logger.debug('Exit GetTransactionDetailsRequest constructor');
  }
...
class GetTransactionDetailsResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetTransactionDetailsResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getTransactionDetailsResponse': this
    };

    _logger.logger.debug('Exit GetTransactionDetailsResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetTransactionDetailsResponse constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('transrefId' in obj && obj.transrefId != null) {
        this.setTransrefId(obj.transrefId);
      }
    } else {
      super();
      this.setTransaction(null);
    ...
    _logger.logger.debug('Exit GetTransactionDetailsResponse constructor');
  }
...
class GetTransactionListForCustomerRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetTransactionListForCustomerRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getTransactionListForCustomerRequest': this
    };

    _logger.logger.debug('Exit GetTransactionListForCustomerRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetTransactionListForCustomerRequest constructor');
    ...
    if (arguments.length == 1) {
      ...
      if ('sorting' in obj && obj.sorting != null) {
        this.setSorting(new TransactionListSorting(obj.sorting));
      }
    ...
    _logger.logger.debug('Exit GetTransactionListForCustomerRequest constructor');
  }
...
class GetTransactionListRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetTransactionListRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getTransactionListRequest': this
    };

    _logger.logger.debug('Exit GetTransactionListRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetTransactionListRequest constructor');
    ...
    _logger.logger.debug('Exit GetTransactionListRequest constructor');
  }
...
class GetTransactionListResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetTransactionListResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getTransactionListResponse': this
    };

    _logger.logger.debug('Exit GetTransactionListResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetTransactionListResponse constructor');
    ...
    _logger.logger.debug('Exit GetTransactionListResponse constructor');
  }
...
class GetUnsettledTransactionListRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter GetUnsettledTransactionListRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getUnsettledTransactionListRequest': this
    };

    _logger.logger.debug('Exit GetUnsettledTransactionListRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetUnsettledTransactionListRequest constructor');
    ...
    _logger.logger.debug('Exit GetUnsettledTransactionListRequest constructor');
  }
...
class GetUnsettledTransactionListResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter GetUnsettledTransactionListResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'getUnsettledTransactionListResponse': this
    };

    _logger.logger.debug('Exit GetUnsettledTransactionListResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter GetUnsettledTransactionListResponse constructor');
    ...
    _logger.logger.debug('Exit GetUnsettledTransactionListResponse constructor');
  }
...
class IsAliveResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter IsAliveResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'isAliveResponse': this
    };

    _logger.logger.debug('Exit IsAliveResponse getJSON');
...
class LogoutRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter LogoutRequest getJSON');
    ...
    _logger.logger.debug('Exit LogoutRequest getJSON');
...
class LogoutResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter LogoutResponse getJSON');
    ...
    _logger.logger.debug('Exit LogoutResponse getJSON');
...
class MobileDeviceLoginRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter MobileDeviceLoginRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'mobileDeviceLoginRequest': this
    };

    _logger.logger.debug('Exit MobileDeviceLoginRequest getJSON');
...
class MobileDeviceLoginResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter MobileDeviceLoginResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'mobileDeviceLoginResponse': this
    };

    _logger.logger.debug('Exit MobileDeviceLoginResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter MobileDeviceLoginResponse constructor');
    ...
    _logger.logger.debug('Exit MobileDeviceLoginResponse constructor');
  }
...
class MobileDeviceRegistrationRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter MobileDeviceRegistrationRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'mobileDeviceRegistrationRequest': this
    };

    _logger.logger.debug('Exit MobileDeviceRegistrationRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter MobileDeviceRegistrationRequest constructor');
    ...
    _logger.logger.debug('Exit MobileDeviceRegistrationRequest constructor');
  }
...
class MobileDeviceRegistrationResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter MobileDeviceRegistrationResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'mobileDeviceRegistrationResponse': this
    };

    _logger.logger.debug('Exit MobileDeviceRegistrationResponse getJSON');
...
class OrderExType extends OrderType {
  constructor(obj) {
    _logger.logger.debug('Enter OrderExType constructor');
    ...
    _logger.logger.debug('Exit OrderExType constructor');
  }
...
class ProfileTransOrderType extends ProfileTransAmountType {
  constructor(obj) {
    _logger.logger.debug('Enter ProfileTransOrderType constructor');
    ...
    _logger.logger.debug('Exit ProfileTransOrderType constructor');
  }
...
class ProfileTransPriorAuthCaptureType extends ProfileTransAmountType {
  constructor(obj) {
    _logger.logger.debug('Enter ProfileTransPriorAuthCaptureType constructor');
    ...
    _logger.logger.debug('Exit ProfileTransPriorAuthCaptureType constructor');
  }
...
class ProfileTransRefundType extends ProfileTransAmountType {
  constructor(obj) {
    _logger.logger.debug('Enter ProfileTransRefundType constructor');
    ...
    _logger.logger.debug('Exit ProfileTransRefundType constructor');
  }
...
class SecurePaymentContainerRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter SecurePaymentContainerRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'securePaymentContainerRequest': this
    };

    _logger.logger.debug('Exit SecurePaymentContainerRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter SecurePaymentContainerRequest constructor');
    ...
    _logger.logger.debug('Exit SecurePaymentContainerRequest constructor');
  }
...
class SecurePaymentContainerResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter SecurePaymentContainerResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'securePaymentContainerResponse': this
    };

    _logger.logger.debug('Exit SecurePaymentContainerResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter SecurePaymentContainerResponse constructor');
    ...
    _logger.logger.debug('Exit SecurePaymentContainerResponse constructor');
  }
...
class SendCustomerTransactionReceiptRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter SendCustomerTransactionReceiptRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'sendCustomerTransactionReceiptRequest': this
    };

    _logger.logger.debug('Exit SendCustomerTransactionReceiptRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter SendCustomerTransactionReceiptRequest constructor');
    ...
    _logger.logger.debug('Exit SendCustomerTransactionReceiptRequest constructor');
  }
...
class SendCustomerTransactionReceiptResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter SendCustomerTransactionReceiptResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'sendCustomerTransactionReceiptResponse': this
    };

    _logger.logger.debug('Exit SendCustomerTransactionReceiptResponse getJSON');
...
class UpdateCustomerPaymentProfileRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter UpdateCustomerPaymentProfileRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'updateCustomerPaymentProfileRequest': this
    };

    _logger.logger.debug('Exit UpdateCustomerPaymentProfileRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter UpdateCustomerPaymentProfileRequest constructor');
    ...
    _logger.logger.debug('Exit UpdateCustomerPaymentProfileRequest constructor');
  }
...
class UpdateCustomerPaymentProfileResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter UpdateCustomerPaymentProfileResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'updateCustomerPaymentProfileResponse': this
    };

    _logger.logger.debug('Exit UpdateCustomerPaymentProfileResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter UpdateCustomerPaymentProfileResponse constructor');
    ...
    _logger.logger.debug('Exit UpdateCustomerPaymentProfileResponse constructor');
  }
...
class UpdateCustomerProfileRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter UpdateCustomerProfileRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'updateCustomerProfileRequest': this
    };

    _logger.logger.debug('Exit UpdateCustomerProfileRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter UpdateCustomerProfileRequest constructor');

    if (arguments.length == 1) {
      super(obj);

      if ('profile' in obj && obj.profile != null) {
        this.setProfile(new CustomerProfileInfoExType(obj.profile));
      }
    } else {
      super();
      this.setProfile(null);
    ...
    _logger.logger.debug('Exit UpdateCustomerProfileRequest constructor');
  }
...
class UpdateCustomerProfileResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter UpdateCustomerProfileResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'updateCustomerProfileResponse': this
    };

    _logger.logger.debug('Exit UpdateCustomerProfileResponse getJSON');
...
class UpdateCustomerShippingAddressRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter UpdateCustomerShippingAddressRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'updateCustomerShippingAddressRequest': this
    };

    _logger.logger.debug('Exit UpdateCustomerShippingAddressRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter UpdateCustomerShippingAddressRequest constructor');
    ...
    _logger.logger.debug('Exit UpdateCustomerShippingAddressRequest constructor');
  }
...
class UpdateCustomerShippingAddressResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter UpdateCustomerShippingAddressResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'updateCustomerShippingAddressResponse': this
    };

    _logger.logger.debug('Exit UpdateCustomerShippingAddressResponse getJSON');
...
class UpdateHeldTransactionRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter UpdateHeldTransactionRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'updateHeldTransactionRequest': this
    };

    _logger.logger.debug('Exit UpdateHeldTransactionRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter UpdateHeldTransactionRequest constructor');

    if (arguments.length == 1) {
      super(obj);

      if ('heldTransactionRequest' in obj && obj.heldTransactionRequest != null) {
        this.setHeldTransactionRequest(new HeldTransactionRequestType(obj.heldTransactionRequest));
      }
    } else {
      super();
    ...
    _logger.logger.debug('Exit UpdateHeldTransactionRequest constructor');
  }

  setHeldTransactionRequest(p_heldTransactionRequest) {
    this.heldTransactionRequest = p_heldTransactionRequest;
  }

  getHeldTransactionRequest() {
...
class UpdateHeldTransactionResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter UpdateHeldTransactionResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'updateHeldTransactionResponse': this
    };

    _logger.logger.debug('Exit UpdateHeldTransactionResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter UpdateHeldTransactionResponse constructor');
    ...
    _logger.logger.debug('Exit UpdateHeldTransactionResponse constructor');
  }
...
class UpdateMerchantDetailsRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter UpdateMerchantDetailsRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'updateMerchantDetailsRequest': this
    };

    _logger.logger.debug('Exit UpdateMerchantDetailsRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter UpdateMerchantDetailsRequest constructor');
    ...
    _logger.logger.debug('Exit UpdateMerchantDetailsRequest constructor');
  }
...
class UpdateMerchantDetailsResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter UpdateMerchantDetailsResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'updateMerchantDetailsResponse': this
    };

    _logger.logger.debug('Exit UpdateMerchantDetailsResponse getJSON');
...
class UpdateSplitTenderGroupRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter UpdateSplitTenderGroupRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'updateSplitTenderGroupRequest': this
    };

    _logger.logger.debug('Exit UpdateSplitTenderGroupRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter UpdateSplitTenderGroupRequest constructor');
    ...
    _logger.logger.debug('Exit UpdateSplitTenderGroupRequest constructor');
  }
...
class UpdateSplitTenderGroupResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter UpdateSplitTenderGroupResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'updateSplitTenderGroupResponse': this
    };

    _logger.logger.debug('Exit UpdateSplitTenderGroupResponse getJSON');
...
class ValidateCustomerPaymentProfileRequest extends ANetApiRequest {
  getJSON() {
    _logger.logger.debug('Enter ValidateCustomerPaymentProfileRequest getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'validateCustomerPaymentProfileRequest': this
    };

    _logger.logger.debug('Exit ValidateCustomerPaymentProfileRequest getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter ValidateCustomerPaymentProfileRequest constructor');
    ...
    _logger.logger.debug('Exit ValidateCustomerPaymentProfileRequest constructor');
  }
...
class ValidateCustomerPaymentProfileResponse extends ANetApiResponse {
  getJSON() {
    _logger.logger.debug('Enter ValidateCustomerPaymentProfileResponse getJSON');

    _utils2.default.delete_null_properties(this, true);

    var obj = {
      'validateCustomerPaymentProfileResponse': this
    };

    _logger.logger.debug('Exit ValidateCustomerPaymentProfileResponse getJSON');

    return obj;
  }

  constructor(obj) {
    _logger.logger.debug('Enter ValidateCustomerPaymentProfileResponse constructor');
    ...
    _logger.logger.debug('Exit ValidateCustomerPaymentProfileResponse constructor');
  }
...
class CustomerAddressExType extends CustomerAddressType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerAddressExType constructor');
    ...
    _logger.logger.debug('Exit CustomerAddressExType constructor');
  }
...
class CustomerPaymentProfileExType extends CustomerPaymentProfileType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerPaymentProfileExType constructor');
    ...
    _logger.logger.debug('Exit CustomerPaymentProfileExType constructor');
  }
...
class CustomerProfileInfoExType extends CustomerProfileExType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerProfileInfoExType constructor');
    ...
    _logger.logger.debug('Exit CustomerProfileInfoExType constructor');
  }
...
class CustomerProfileMaskedType extends CustomerProfileExType {
  constructor(obj) {
    _logger.logger.debug('Enter CustomerProfileMaskedType constructor');
    ...
    _logger.logger.debug('Exit CustomerProfileMaskedType constructor');
  }
...
class ProfileTransCaptureOnlyType extends ProfileTransOrderType {
  constructor(obj) {
    _logger.logger.debug('Enter ProfileTransCaptureOnlyType constructor');
    ...
    _logger.logger.debug('Exit ProfileTransCaptureOnlyType constructor');
  }
...
class SubscriptionCustomerProfileType extends CustomerProfileExType {
  constructor(obj) {
    _logger.logger.debug('Enter SubscriptionCustomerProfileType constructor');
    ...
    _logger.logger.debug('Exit SubscriptionCustomerProfileType constructor');
  }
