...
class TransactionResponse.EmvController extends APIOperationBase {
    constructor(apiRequest) {
        logger.debug('Enter TransactionResponse.EmvController constructor');
        super(apiRequest);
        logger.debug('Exit TransactionResponse.EmvController constructor');
    }
    ...
    getRequestType(){
        return 'TransactionResponse.EmvRequest';
    }
}

module.exports.TransactionResponse.EmvController = TransactionResponse.EmvController;
